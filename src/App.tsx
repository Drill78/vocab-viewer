...
export const ThemedInput = (props: any) => (
  <BaseInput
    {...props}
    className={`bg-white border border-neutral-300 text-neutral-900 placeholder-neutral-400 
...
export const ThemedSelectTrigger = (props: any) => (
  <BaseSelectTrigger
    {...props}
    className={`bg-white border border-neutral-300 text-neutral-900 
        ...
        <section className="mt-4">
          <Card className="border-neutral-200/70 dark:border-neutral-800/70">
            ...
            <CardContent className="grid gap-3 md:grid-cols-3">
              <div className="flex items-center gap-2">
                <ThemedInput type="file" accept=".csv" ref={fileRef} onChange={(e) => {
              ...
              <div className="flex items-center gap-2 md:col-span-2">
                <ThemedInput placeholder="或粘贴 CSV 链接（支持 GitHub Raw / 公网直链）" ref={urlRef}/>
        ...
        <section className="mt-4 flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
          <div className="flex-1 flex items-center gap-2">
            <div className="relative flex-1">
              <ThemedInput placeholder="搜索单词、释义、例句或标签…" value={query} onChange={(e) => setQuery(e.target.value)} className="pl-9"/>
              <Search className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-neutral-400"/>
            </div>
            <Select value={pos} onValueChange={setPos}>
              <ThemedSelectTrigger className="w-36"><SelectValue placeholder="词性"/></ThemedSelectTrigger>
              <SelectContent>
            ...
            <Select value={tag} onValueChange={setTag}>
              <ThemedSelectTrigger className="w-40"><SelectValue placeholder="标签"/></ThemedSelectTrigger>
              <SelectContent>
            ...
            <Select value={sortBy} onValueChange={setSortBy}>
              <ThemedSelectTrigger className="w-36"><SelectValue placeholder="排序"/></ThemedSelectTrigger>
              <SelectContent>
